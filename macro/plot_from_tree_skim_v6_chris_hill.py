...
ERA = "2016"
NTUPLEDIR   = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_"+str(ERA)+"_SR_chris_hill/"
PLOTDIR     = "plots/v6_calo_AOD_"+str(ERA)+"_SR_chris_hill/"
