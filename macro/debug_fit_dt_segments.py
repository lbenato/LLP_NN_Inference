...
OUT = "/afs/desy.de/user/l/lbenato/LLP_inference/CMSSW_11_1_3/src/NNInferenceCMSSW/LLP_NN_Inference/plots/v6_calo_AOD_2017_BeamHalo_studies_updated/"
...
for d in data:
    ...
    list_of_variables = ["nTagJets_0p996_JJ","EventNumber","LumiNumber","RunNumber","nDTSegments","nCosmicMuons","nCosmicMuonsOneLeg","DTSegments.x","DTSegments.y","DTSegments.z","CSCSegments.x","CSCSegments.y","CSCSegments.z","DTSegments.time","skimmedEcalRecHitsAK4.x","skimmedEcalRecHitsAK4.y","skimmedEcalRecHitsAK4.z","taggedAcceptanceEcalRecHitsAK4.x","taggedAcceptanceEcalRecHitsAK4.y","taggedAcceptanceEcalRecHitsAK4.z","Jets.pt","Jets.eta","Jets.sigprob","HLT*","MT","HT","pt","MinJet*DPhi*","nCHSJetsAcceptanceCalo","nCHSJets_in_HEM*","EventWeight","PUWeight","PUReWeight","Jets.isGenMatchedCaloCorrLLPAccept","isSR","isMC","DTSegments.eta","DTSegments.phi","CSCSegments.eta","CSCSegments.phi","taggedAcceptanceEcalRecHitsAK4.eta","taggedAcceptanceEcalRecHitsAK4.phi","skimmedEcalRecHitsAK4.eta","skimmedEcalRecHitsAK4.phi","min_dPhi_jets"]#,"CosmicMuons.eta","CosmicMuons.phi","CosmicMuonsOneLeg.eta","CosmicMuonsOneLeg.phi"]#,"CosmicMuonsPropagated.eta","CosmicMuonsPropagated.phi","CosmicMuonsPropagatedOneLeg.eta","CosmicMuonsPropagatedOneLeg.phi"]
    ...
    for arrays in gen:
        ...
        #ECAL_tag_x = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.x"].flatten(),100.)
        #ECAL_tag_y = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.y"].flatten(),100.)
        #ECAL_tag_z = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.z"].flatten(),100.)
        ...
        ECAL_tag_x = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.x"][cut_mask],100.)
        ECAL_tag_y = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.y"][cut_mask],100.)
        ECAL_tag_z = np.divide(arrays["taggedAcceptanceEcalRecHitsAK4.z"][cut_mask],100.)
        ECAL_tag_eta = arrays["taggedAcceptanceEcalRecHitsAK4.eta"][cut_mask]
        ECAL_tag_phi = arrays["taggedAcceptanceEcalRecHitsAK4.phi"][cut_mask]
    ...
    for ev in range(EventNumber.shape[0]):
        ...
        #chain.Project("h_xy_ecal_tag", "taggedAcceptanceEcalRecHitsAK4.y/100.:taggedAcceptanceEcalRecHitsAK4.x/100.", "")
        ...
        #chain.Project("h_xyz_ecal_tag", "taggedAcceptanceEcalRecHitsAK4.y/100.:taggedAcceptanceEcalRecHitsAK4.x/100.:taggedAcceptanceEcalRecHitsAK4.z/100.", "")
        ...
        #chain.Project("h_xz_ecal_tag", "taggedAcceptanceEcalRecHitsAK4.x/100.:taggedAcceptanceEcalRecHitsAK4.z/100.", "")
        ...
        #chain.Project("h_yz_ecal_tag", "taggedAcceptanceEcalRecHitsAK4.y/100.:taggedAcceptanceEcalRecHitsAK4.z/100.", "")
