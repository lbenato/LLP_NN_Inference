...
NTUPLEDIR = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_"+ERA+"_E_v5_ntuples_reweighted/weighted/"#"#
PLOTDIR     = "plots/v6_calo_AOD_"+ERA+"_E_v5_ntuples_reweighted/weighted/"#"#
...
def plot(var, cut, cut_s, cut_d="", tree_name="tree",norm=False):
    ...
    #weight = "(EventWeight*PUWeight)/(HTWeight*EleWeight)"
