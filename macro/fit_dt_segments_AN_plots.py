...
MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_SR_bin_1_2/"
#MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_SR/"
##OUT = "/afs/desy.de/user/l/lbenato/LLP_inference/CMSSW_11_1_3/src/NNInferenceCMSSW/LLP_NN_Inference/plots/v6_cosmic_veto_v3/"
OUT = "/afs/desy.de/user/l/lbenato/LLP_inference/CMSSW_11_1_3/src/NNInferenceCMSSW/LLP_NN_Inference/plots/v6_calo_AOD_2016_cosmic_AN/"
...
for d in data:
    ...
    for arrays in gen:
        ...
        dt_ecal_dist = arrays["dt_ecal_dist"][cut_mask]
    ...
    for ev in range(EventNumber.shape[0]):
        ...
        leg.AddEntry(fit_dt_xy,("3D line fit distance: %.1f m"%dt_dist),"PF")
        ...
        leg.AddEntry(fit_dt_xz,("3D line fit distance: %.1f m"%dt_dist),"PF")
        ...
        leg.AddEntry(fit_dt_yz,("3D line fit distance: %.1f m"%dt_dist),"PF")
        ...
        leg.AddEntry(fit_dt_3d,("3D line fit distance: %.1f m"%dt_dist),"PF")
