...
ERA                = "2017"
REGION             = "WtoMN"
CUT                = "isWtoMN"#"isJetMET_low_dPhi_MET_200_Lep"#"isJetHT_unprescaled"#"isWtoEN"# && MT<100"#"isZtoMM"
...
def draw_tag_eff(sample_list,add_label="",check_closure=False):
    ...
    for i, s in enumerate(sample_list):
        ...
        graph[s].GetYaxis().SetRangeUser(-0.0001,0.02 if check_closure else maxeff)
...
background_prediction_new(get_tree_weights(samples_to_run),
                          samples_to_run,
                          extr_regions=["MN","WtoMN"],
                          regions_labels = ["",""],
                          add_label="_closure",
                          label_2="_extrapolation_to_WtoMN_closure",check_closure=True)
