...
#year = "2017"
year = "2018"
base_path = "/afs/desy.de/user/l/lbenato/LLP_code_slc7/CMSSW_10_2_18/src/HiggsAnalysis/CombinedLimit/v6_calo_AOD_%s_SR_DS/SUSY/HeavyHiggs/datacards/"
path = "/afs/desy.de/user/l/lbenato/LLP_code_slc7/CMSSW_10_2_18/src/HiggsAnalysis/CombinedLimit/v6_calo_AOD_"+year+"_SR_DS/SUSY/HeavyHiggs/datacards/"
filename = "ctau_weights_dict_HeavyHiggsToLLPTo"+ch+"_mH800_mX350.yaml"
filename = "ctau_weights_dict_HeavyHiggsToLLPTo"+ch+"_mH800_mX80.yaml"
filename = "ctau_weights_dict_HeavyHiggsToLLPTo"+ch+"_mH400_mX150.yaml"
#filename = "ctau_weights_dict_HeavyHiggsToLLPTo"+ch+"_mH400_mX40.yaml"
