...
#from Analyzer.LLP2016.drawUtils import *
...
##MAIN = "/afs/desy.de/user/l/lbenato/LLP_code_slc7/CMSSW_10_2_18/src/Analyzer/LLP2016/"
...
##MAIN = "/nfs/dust/cms/group/cms-llp/v5_calo_AOD_2016_ZtoMM/"
MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_Gen_ZZ/"
#MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_SR_bin_1_2/"

#MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_SR/"
#MAIN = "/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_2016_SR_bin_1_2/"
#OUT = "plots/v6_calo_AOD_2016_BeamHalo_AN/"
...
def count(label,do_eta=False):
    ...
    for d in data:
        ...
        for arrays in gen:
            ...
            #cut_mask_v = arrays["min_dPhi_jets_eta_1p0_0p996"]<0.05
            #cut_mask = np.logical_and(cut_mask,np.logical_not(cut_mask_v))
...
def draw(label):
    ...
    for c in ctau:
        ...
        eff_pr_m[c].SetLineWidth(2)
        eff_b2_pre_m[c].SetLineWidth(2)
        eff_b2_post_m[c].SetLineWidth(2)
...
def draw_eff(label,do_eta=False):
    ...
    mg.SetMaximum(101)
    mg.Draw("AL")
    drawCMS_simple(-1, "Simulation", ERA="2016", onTop=True)
    leg1.Draw()
    '''
    c1.cd(2)
    mg_ratio.GetXaxis().SetTitle("m_{\chi} (GeV)")
