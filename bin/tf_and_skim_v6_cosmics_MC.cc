...
int main(int argc, char **argv) {
    ...
    */
    ...
    std::vector<GenPType> *GenParticles= 0;
    ...
    inputTree->SetBranchAddress("nGenParticles",      &nGenParticles,      &b_nGenParticles);
    inputTree->SetBranchAddress("GenParticles",      &GenParticles,      &b_GenParticles);
    ...
    */
    ...
    outputTree->Branch("nGenParticles",      &nGenParticles,      "nGenParticles/I");
    ...
    outputTree->Branch("GenParticles",      &GenParticles);
    /*
