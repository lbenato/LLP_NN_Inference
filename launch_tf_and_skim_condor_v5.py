...
doRegion = "doWtoEN"#"doSR"#"doTtoEM"#"doZtoEE"#MN/EN
resubm_label = ""
...
if resubm_label=="_resubmission_0" or resubm_label=="":
    ...
    if RUN_ERA==2018 and doRegion == "doSR":
        INPUTDIR = ("/pnfs/desy.de/cms/tier2/store/user/lbenato/v5_calo_AOD_%s_30March2021_HEM/")% str(RUN_ERA)
        print "2018 HEM folder for data!"
        #print "BUT ITS MC SO: "
        #INPUTDIR = ("/pnfs/desy.de/cms/tier2/store/user/lbenato/v5_calo_AOD_%s_31December2020/")% str(RUN_ERA)
    elif RUN_ERA==2017 and doRegion == "doSR":
        #INPUTDIR = ("/pnfs/desy.de/cms/tier2/store/user/lbenato/v5_calo_AOD_%s_31December2020/")% str(RUN_ERA)
        print "BUT ITS signal with proper JER SO: "
        INPUTDIR = ("/pnfs/desy.de/cms/tier2/store/user/lbenato/v5_calo_AOD_%s_31August2021_JER/")% str(RUN_ERA)
        print INPUTDIR
    else:
...
OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_%s_WtoEN/")%(RUN_ERA)
#OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_August_2021/v5_calo_AOD_%s"+resubm_label+"_JER_no_cuts/")% str(RUN_ERA)
#INPUTDIR = ("/pnfs/desy.de/cms/tier2/store/user/lbenato/v5_calo_AOD_%s_30March2021_HEM/")% str(RUN_ERA)
#OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_%s_SR_HEM"+resubm_label+"/")% str(RUN_ERA)


'''
OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_August_2021/v5_calo_AOD_%s_SR"+resubm_label+"/")% str(RUN_ERA)
OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_August_2021/v5_calo_AOD_%s_SR"+resubm_label+"_JER/")% str(RUN_ERA)
OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v5_calo_AOD_August_2021/v5_calo_AOD_%s_SR"+resubm_label+"_JER_for_AN/")% str(RUN_ERA)
print "\n"
print "Using signal with correct JER applied!"
print "\n"
'''
...
sample_list = back#sign#data#sign#data#back#sign#data#back#sign#data#sign#back#data#back#sign#sign#data#back#sign#data#back#data#data+back
...
if run_condor:
    ...
    for s in sample_to_loop:
        ...
        for subd in num_subdirs:
            ...
            #cond_name = "skim_2017_v5"
            cond_name = "skim_"+str(RUN_ERA)+"_v5_no_cuts_unc_"+doRegion#+"_MC"
            cond_name = "skim_"+str(RUN_ERA)+"_v5_JER_for_AN_limits_"+doRegion#+"_MC"
            cond_name = "skim_"+str(RUN_ERA)+"_v5_check_DNN_sculpting_"+doRegion#+"_MC"
            cond_name = "skim_"+str(RUN_ERA)+"_v5_"+doRegion#+"_MC"
            #cond_name = "debug_v5_new"
            ...
            for a in range(0,len(root_files),root_files_per_job):
                ...
                with open('job_skim_'+str(j_num)+'.sh', 'w') as fout:
                    ...
                    for b in np.arange(start,stop+1):
                        ...
                        #HEM
                        fout.write('echo ../bin/slc7_amd64_gcc820/tf_and_skim_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' '  + doRegion + ' \n')
                        fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' \n')
                        #Syst unc
                        #fout.write('echo ../bin/slc7_amd64_gcc820/sign_unc_tf_and_skim_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' \n')
                        #fout.write('../bin/slc7_amd64_gcc820/sign_unc_tf_and_skim_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' \n')
                        #Syst unc and no cuts
                        #fout.write('echo ../bin/slc7_amd64_gcc820/sign_no_cuts_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' \n')
                        #fout.write('../bin/slc7_amd64_gcc820/sign_no_cuts_v5_HEM ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' \n')
                        #Gen
                        #fout.write('echo ../bin/slc7_amd64_gcc820/tf_and_skim_v5_gen ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + doRegion + ' \n')
                        #fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_v5_gen ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + doRegion + ' \n')
                        ##With PU reweight
                        #fout.write('echo ../bin/slc7_amd64_gcc820/tf_and_skim_v5_debug_new ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + doRegion + ' \n')
                        #fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_v5_debug_new ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + doRegion + ' \n')
                        ##Old approach for debuggin
                        ##fout.write('echo ../bin/slc7_amd64_gcc820/tf_and_skim_v5_debug_old ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' \n')
                        ##fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_v5_debug_old ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + '  \n')



                        #fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_AK4_v3__AK8_v2__v5 ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + isSignal  + ' ' + mc_PU_file+' ' + data_file  + ' ' + data_file_up + ' ' + data_file_down + ' \n')
                ...
                with open('submit_skim_'+str(j_num)+'.submit', 'w') as fout:
                    ...
                    fout.write(' \n')
                    #fout.write('## Make sure jobs dont start running too many times \n')
                    #fout.write('NumRestarts = 10 \n')
                    #fout.write('NumShadowStarts = 20 \n')
