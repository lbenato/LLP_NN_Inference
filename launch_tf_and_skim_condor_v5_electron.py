...
doRegion = "doE"#"doZtoMMPho"#"doSR"#"doTtoEM"#"doZtoEE"#MN/EN
resubm_label = ""
...
OUTPUTDIR = ("/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_%s_E"+resubm_label+"_v5_ntuples_reweighted/")%(RUN_ERA)
...
HT_ratio_file = ("/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_%s_E_v5_ntuples_scale_factors/data_MC_HT_ratio.root")  % str(RUN_ERA)
ele_ratio_file = ("/nfs/dust/cms/group/cms-llp/v6_calo_AOD/v6_calo_AOD_%s_E_v5_ntuples_scale_factors/data_MC_Electrons_pt_ratio.root") % str(RUN_ERA)
...
sample_list = back#data#back#data#back#data#back# data#sign#data#sign#back#sign#data#sign#data#back#sign#data#back#sign#data#sign#back#data#back#sign#sign#data#back#sign#data#back#data#data+back
...
if run_condor:
    ...
    for s in sample_to_loop:
        ...
        for subd in num_subdirs:
            ...
            cond_name = "skim_"+str(RUN_ERA)+"_v5_"+doRegion
            ...
            for a in range(0,len(root_files),root_files_per_job):
                ...
                with open('job_skim_'+str(j_num)+'.sh', 'w') as fout:
                    ...
                    for b in np.arange(start,stop+1):
                        ...
                        #HEM
                        #fout.write('echo ../bin/slc7_amd64_gcc820/tf_and_skim_v5_electron ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' '  + doRegion + ' ' + HT_ratio_file + ' ' + ele_ratio_file + ' \n')
                        fout.write('../bin/slc7_amd64_gcc820/tf_and_skim_v5_electron ' + INPS+root_files[b] + '  ' + OUT+root_files[b] + skip_string  + ' ' + str(isSignal) + ' ' + str(isData)  + ' ' + mc_PU_file+ ' ' + mc_trigger_file + ' ' + mc_trigger_string + ' ' + doRegion + ' ' + HT_ratio_file + ' ' + ele_ratio_file + ' \n')
